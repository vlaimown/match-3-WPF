...
namespace Match3
{
    public class HorizontalCapsule : Item
    {
        private int widthOffset; 
        private int heigthOffset;
        public HorizontalCapsule(int value, int coef, Cell cell) : base(value, coef, cell)
        {
            base.value = value;
            ...
            shape.Fill = System.Windows.Media.Brushes.Magenta;
